...
/**
 * Created by felipeweb on 5/14/16.
 */
public class EventoPublicacoesRecebidas extends BroadcastReceiver {
	...
	public static EventoPublicacoesRecebidas registraObservador(BuscaMaisPublicacoesDelegate delegate) {
		...
		LocalBroadcastManager.getInstance(delegate.getCarangosApplication()).registerReceiver(receiver, new IntentFilter(PUBLICACOES_RECEBIDAS));
		return receiver;
	}
	...
	public void desregistra(CarangosApplication application) { LocalBroadcastManager
