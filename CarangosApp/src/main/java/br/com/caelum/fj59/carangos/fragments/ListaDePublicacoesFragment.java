...
public class ListaDePublicacoesFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		this.swipe.setColorSchemeResources(android.R.color.holo_blue_bright, android.R.color.holo_green_light,
				android.R.color.holo_orange_light,
				android.R.color.holo_red_light);
		this.publicacoesList = (ListView) swipe.findViewById(R.id.publicacoes_list);
		PublicacaoAdapter publicacaoAdapter = new PublicacaoAdapter(getActivity(), ((CarangosApplication) activity.getApplication()).getPublicacoes());
